...
const updateItem = (id) => {
    // Inertia.put('URI', 渡す値（オブジェクト：上で定義）);
    // Inertia.put(`/items/${id}`, form);
    Inertia.put(route('items.update', { item: id }), form); // 別記法

    // 更新前に確認を挟みたい
    // Inertia.put(route('items.update', { item: id }), {
	//     onBefore: () => confirm(`${id}番目の記事を本当に更新しますか？`)
	// });
}
</script>
                                ...
                                <div class="container px-5 py-8 mx-auto">
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="is_selling" class="leading-7 text-sm text-gray-600">商品ステータス</label>
                                                    <!-- コントローラーから入ってきたis_sellingの値に応じて、チェックが入る -->
